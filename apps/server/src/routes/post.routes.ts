...
import { createAPost, getAllPost, getPost, deletePost } from "../controllers/post.controller.js";
...
router.route("/:postId").get(getPost).post(answerToTheQuestion).delete(deletePost);
