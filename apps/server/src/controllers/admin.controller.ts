...
const handleLogin = asyncHandler(async (req: Request, res: Response) => {
  if (!req.body) {
    throw new ApiError(400, "email and password are require for authentication");
  }
...
const getAllUsers = asyncHandler(async (_: Request, res: Response) => {
  ...
  return res.status(200).json(new ApiResponse(200, allUsers[0], "users found successfully"));
});
...
const getUser = asyncHandler(async (req: Request, res: Response) => {
  ...
  return res.status(200).json(new ApiResponse(200, userObj, "user data fetch successfully"));
});
...
const deletePost = asyncHandler(async (req: Request, res: Response) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, {}, "Post and associated answers deleted successfully"));
});
...
const deleteAnswer = asyncHandler(async (req: Request, res: Response) => {
  ...
  return res.status(200).json(new ApiResponse(200, {}, "Answer deleted successfully"));
});
...
const getAnalytics = asyncHandler(async (req: Request, res: Response) => {
  ...
  return res.status(200).json(new ApiResponse(200, analyticsData, "Data Fetch successfully"));
});
